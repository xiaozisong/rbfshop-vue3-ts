  ...
  <div class="sub-category">
    <div class="container">
      ...
      <XtxBread>
        ...
        <XtxBreadItem :to="`/category/${subCategory.parentId}`">{{ topCategory.name }}</XtxBreadItem>
      ...
      <div class="goods-list">
        ...
        <!-- 商品列表 -->
        <ul>
          <li v-for="goods in category.subCategory.goods" :key="goods">
...
const { topCategory, subCategory } = storeToRefs(category)
watchEffect(() => {
